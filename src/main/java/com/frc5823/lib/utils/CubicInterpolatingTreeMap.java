...
public class CubicInterpolatingTreeMap<
        K extends InterpolatingDouble, V extends ICubicInterpolable<V>>
    extends TreeMap<K, V> {
  private static final long serialVersionUID = 8347275262778054124L;

  int max_;

  public CubicInterpolatingTreeMap(int maximumSize) {
    max_ = maximumSize;
  }

  public CubicInterpolatingTreeMap() {
    this(0);
  }
  ...
  public V getInterpolated(K key) {
    ...
    if (gotval == null) {
      ...
      return bottomElem.cubicInterpolate(
          topElem,
