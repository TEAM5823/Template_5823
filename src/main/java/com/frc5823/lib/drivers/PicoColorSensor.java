...
public class PicoColorSensor implements AutoCloseable {
  public static class RawColor {
    ...
    public boolean closeTo(RawColor ref_color, double all_tolerance) {
      return Util.epsilonEquals(red, ref_color.red, all_tolerance)
          && Util.epsilonEquals(green, ref_color.green, all_tolerance)
          && Util.epsilonEquals(blue, ref_color.blue, all_tolerance);
    }

    public boolean closeTo(
        RawColor ref_color, double red_tolerance, double green_tolerance, double blue_tolerance) {
      return Util.epsilonEquals(red, ref_color.red, red_tolerance)
          && Util.epsilonEquals(green, ref_color.green, green_tolerance)
          && Util.epsilonEquals(blue, ref_color.blue, blue_tolerance);
    }
  }
