...
/* GuidingVectorField switchAvoidanceCW = new GuidingVectorField(new PolyCone(new ArrayList<Translation2d> {
		Config.kLeftSwitchCloseCorner,
		Config.kLeftSwitchFarCorner,
		Config.kRightSwitchFarCorner,
		Config.kRightSwitchCloseCorner
	}));
*/
public class PolyCone extends BaseSurface {
  // first point lies on z=-1
  // second and third points lie on z=0
  // therefore z1-z0 and z2-z0 are both 1
  public class PlaneSegment extends BaseSurface {
