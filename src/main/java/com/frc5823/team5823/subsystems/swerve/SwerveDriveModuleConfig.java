...
public final class SwerveDriveModuleConfig {
  public static final class Translation {
    ...
    // public static final double ENCODER_TO_WHEEL_RATIO = 570.0 / 91.0; // WCP swerve module
    public static final double ENCODER_TO_WHEEL_RATIO = 38250.0 / 5670.0; // MK4i swerve module
  ...
  public static final class Rotation {
    ...
    public static final double ENCODER_TO_MODULE_BASE_RATIO = 12.0; // WCP swerve module
    // public static final double ENCODER_TO_MODULE_BASE_RATIO = 3000.0 / 140.0; // MK4i swerve module
